# From Li et al.'s othello_world (https://github.com/likenneth/othello_world, mingpt/model.py;
# MIT, Copyright (c) 2023 Kenneth Li; see LICENSE here), with its unused classes and methods removed.
# That file derives from Andrej Karpathy's minGPT (https://github.com/karpathy/minGPT; MIT).
"""
GPT model:
